...
## --------------------------------------------------------------------
b1 = tkinter.Button(window, text="left-0")
...
b1.pack(side='left')             # - [기본] 버튼위에 txt 보여질 마큼 w, h 크기로 버튼 배치
b1_1.pack(side='left', fill='x') # side가 탑인 경우 x축만 fill 가능
...
b4.pack(side='left')
b4_1.pack(side='left', anchor='s') # side가 right인 경우 y만 fill 가능
